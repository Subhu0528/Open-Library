...
public class QuizController {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> completeQuiz(@PathVariable Long quizId, @RequestBody Map<String, Object> request) {
        try {
            ...
            if (answers != null) {
                ...
                for (Map<String, Object> answer : answers) {
                    ...
                    if (questionIndex >= 0 && questionIndex < questions.size()) {
                        ...
                        System.out.println("Question " + (questionIndex + 1) + ": User=" + userAnswer + ", Correct=" + question.getCorrectAnswer() + ", IsCorrect=" + isCorrect);
                    }
                }
            }
            ...
            System.out.println("Quiz completed. Correct: " + correctAnswers + "/" + questions.size() + " = " + percentage + "%");
    ...
    public String getQuizResult(@PathVariable Long quizId, Model model) {
        try {
            ...
            for (int i = 0; i < questions.size(); i++) {
                ...
                System.out.println("Q" + (i+1) + ": UserAnswer=" + q.getUserAnswer() + ", CorrectAnswer=" + q.getCorrectAnswer() + ", IsCorrect=" + q.getIsCorrect());
            }
